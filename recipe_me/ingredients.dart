...
void main() {
  runApp(new MaterialApp(
    ...
    home: SearchList(product: [
      ...
      new Product('apple juice', false),
      new Product('avocado roll', false),
      new Product('bruscetta', false),
      ...
      new Product('dumplings', false),
      new Product('donuts', false),
      new Product('eggs', false),
      new Product('enchilada', false),
      new Product('eggrolls', false),
      new Product('edimame', false),
      new Product('eel', false),
      new Product('fajita', false),
      new Product('fish', false),
      new Product('french toast', false),
      ...
      new Product('gumbo', false),
      new Product('graham crackers', false),
      new Product('ham', false),
      new Product('honey', false),
      new Product('hash browns', false),
      new Product('hot dogs', false),
